...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || 'inrl~7af3bzTQ057731f31cdd8983f9de4b84380b', //your ssid to run bot
    HEROKU: {
    ...
    BOT_INFO : process.env.BOT_INFO || "MAC-MD-V3;INRL;https://i.imgur.com/DyLAuEh.jpg",
    WORKTYPE : 'public',//process.env.WORKTYPE || "public",
    PREFIX : process.env.PREFIX || "[/,!]",
    LANG : process.env.LANG || "en",
    PERSONAL_MESSAGE: process.env.PERSONAL_MESSAGE || "null",
    BLOCK_CHAT : process.env.BLOCK_CHAT || "null",
    BOT_PRESENCE : process.env.BOT_PRESENCE || "unavailable",
    AUDIO_DATA : process.env.AUDIO_DATA || "MAC-MD-V3;INRL;https://i.imgur.com/DyLAuEh.jpg",
